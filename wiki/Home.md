# ⚡ Welcome to the Agentway Wiki

> **The Autonomous Product Design, Architecture & QA Engine for AI Coding Agents**

Agentway equips AI agents (Claude Code, Google Antigravity, Cursor, Windsurf, OpenCode) with **42 production-grade engineering protocols** across 9 specialized domains.
...
| **[🗺️ Complete Skill Catalog](Skill-Catalog)** | Comprehensive encyclopedia of all 42 skills across 9 domains with triggers. | Prompt engineers & Builders |
...
| **[🧭 Roadmap & Status](Roadmap-and-Vision)** | Version history, current v1.4 status, and upcoming v2.0 milestone features. | Community & Stakeholders |
| **[✍️ Contributing Guide](Contributing-and-Skill-Authoring)** | Guidelines for authoring new skills, quality scoring standards, and testing. | Open-source Contributors |

---

## 📊 Live Project Status & Telemetry (v1.4.0)

- **Total Active Skills:** `42 modular protocols`
- **Domain Coverage:** `9 pillars` (Visual, Product, UX, UI, Modern, Responsive, Growth, Delivery, QA)
- **Runtime Footprint:** `0 tokens idle` (On-demand context disclosure)
...
```bash
# Provision Agentway in any workspace
