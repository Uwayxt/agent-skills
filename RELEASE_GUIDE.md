...
| **MINOR (v1.7.0)** | Adding new skills, new CLI generator subcommands, or major domain capabilities without breaking existing setups. | `1.4.0` → `1.7.0` |
...
1. **Lockfile Hash Verification:**
   Ensure all 47 skills have exact SHA-256 hashes in `skills-lock.json`:
   ```bash
